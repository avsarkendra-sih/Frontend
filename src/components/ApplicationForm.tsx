...
export function ApplicationForm() {
  ...
  switch (currentStep) {
    case "personal-information":
      filledFormData = useApplicationFormStore((state) => state.personalInfo);
      break;
    case "academic-details":
      filledFormData = useApplicationFormStore((state) => state.academicDetails);
      break;
    case "skills-projects-certifications":
      filledFormData = useApplicationFormStore((state) => state.skillsProjects);
      break;
    case "uploads":
      filledFormData = useApplicationFormStore((state) => state.uploads);
      break;
    case "preferences-career-interests":
      filledFormData = useApplicationFormStore((state) => state.preferencesCareerInterests);
      break;
    default:
      break;
  }
  ...
  const saveForLater = async () => {
    ...
    const response = await fetch(`${"http://localhost:3000"}/api/personal/createPI`, {
      method: "POST",
      headers: {
