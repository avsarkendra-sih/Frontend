...
export function Uploads() {
  ...
  const renderFilePreview = (file: File | null) => {
    ...
    if (file.type.startsWith('image/')) {
      return <div className="mt-2 rounded-md overflow-hidden border border-border">
          <img src={URL.createObjectURL(file)} alt="Preview" className="max-h-32 object-contain mx-auto" />
        </div>;
    }
    // For PDF or other files
    return <div className="mt-2 p-3 rounded-md border border-border flex items-center gap-2 text-sm">
        {file.type === 'application/pdf' ? <FileTextIcon className="h-5 w-5 text-red-500" /> : <FileIcon className="h-5 w-5 text-blue-500" />}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardContent className="p-4 space-y-2">
            <FormField control={control} name="uploads.profilePhoto" render={({
            field
          }) => <FormItem>
                  ...
                  <FormControl>
                    <div className="flex flex-col items-center justify-center border-2 border-dashed border-border rounded-md p-4 transition-colors hover:border-primary/50">
                      ...
                      <Input type="file" accept="image/*" className="max-w-xs" onChange={e => {
        ...
        <Card>
          <CardContent className="p-4 space-y-2">
            <FormField control={control} name="uploads.signature" render={({
            field
          }) => <FormItem>
                  <FormLabel className="flex items-center">
        ...
        <Card>
          <CardContent className="p-4 space-y-2">
            <FormField control={control} name="uploads.tenthMarksheet" render={({
            field
          }) => <FormItem>
                  <FormLabel className="flex items-center">
        ...
        <Card>
          <CardContent className="p-4 space-y-2">
            <FormField control={control} name="uploads.twelfthMarksheet" render={({
            field
          }) => <FormItem>
                  <FormLabel className="flex items-center">
